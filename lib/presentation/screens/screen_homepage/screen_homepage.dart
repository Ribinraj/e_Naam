...
Future<void> _onRefresh() async {
  // allow the alert to show again if profile is still incomplete
  _isAlertShown = false;
  ...
  context.read<FetchProfileBloc>().add(FetchProfileInitialEvent());
  context.read<FetchCategoriesBloc>().add(FetchCategoriesInitialeEvent());
  context.read<FetchLatestProductBloc>().add(FetchLatestProductInitialEvent());

  // small delay so the RefreshIndicator has time to show
