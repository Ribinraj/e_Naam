...
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:solar_icons/solar_icons.dart'; // Ensure this is imported properly
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 60), // Center FAB space
                      _buildNavItem(
                        context,
                        3,
                        state.currentPageIndex,
              ...
              Positioned(
                ...
                child: Center(
                  child: FloatingActionButton(
                    ...
                    elevation: 4,
                    onPressed: () {
                      onTap?.call(2); // Trigger Scan page index directly
                    },
                    child: const Icon(
                      SolarIconsOutline.qrCode,
                      color: Colors.white,
